...
exports.getAllFaculty = async (req, res, next) => {
  try {
    ...
    if (req.query.department && req.query.department !== 'All') {
      ...
      const mappedDept = deptMapping[req.query.department] || req.query.department;
      
      // Use regex to match either the full name or the abbreviation (case-insensitive)
      query.department = { $regex: `^${mappedDept}$`, $options: 'i' };
    }
