...
const { searchStudent, updateStudent, getAllStudents, deleteStudent, getOfferedCourses, selfEnroll, promoteStudents, autoAssignSections, getSectionStats, deleteSection, mergeSections, getActiveSections, updateStudentStatus, runPromotionCycle } = require('../controllers/studentController');
